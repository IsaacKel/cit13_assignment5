...
public class Authenticator
{
  ...
  public virtual bool passwordIsOK(string password, string username)
  {
    ...
    {
      Console.WriteLine("Password must contain more than eight characters.");
      return false;
    }

    // Check if password contains the entire username as a substring
    if (password.Contains(username))
    {
      Console.WriteLine("Password cannot contain the username.");
      return false;
    }
